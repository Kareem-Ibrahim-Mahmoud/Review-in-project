        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeOfLastModification = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExecutedQuantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AverageExecutionPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_orders_status_OrderStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Log_orders_orderid",
                        column: x => x.orderid,
                        principalTable: "orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Log_status_OrderStatusId",
                        column: x => x.OrderStatusId,
                        principalTable: "status",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
